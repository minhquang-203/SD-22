...
import { ADMIN_MENU, findExpandedKeys } from '@/constants/adminMenu'
...
const menuOptions = computed(() => buildAdminMenuOptions(ADMIN_MENU))
...
watch(
  () => route.path,
  (path) => {
    expandedKeys.value = findExpandedKeys(path)
  },
  { immediate: true },
)
</script>
    ...
    >
      <div class="admin-sidebar-naive__brand">
        <svg class="admin-sidebar-naive__logo" viewBox="0 0 32 32" fill="none">
          <path d="M16 3L6 8.5V20.5L16 26l10-5.5V8.5L16 3z" fill="#18a058" />
