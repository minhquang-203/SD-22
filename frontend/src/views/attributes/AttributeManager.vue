        ...
        <div class="p-5 space-y-4">
          ...
          <div v-for="field in config.fields" :key="field.key">
            ...
            <input
              ...
              :value="modalMode === 'edit' ? form[field.key] : ''"
              class="admin-input bg-[var(--mist)] text-[var(--admin-muted)] cursor-not-allowed"
              readonly
              :placeholder="field.placeholder || 'Mã sẽ tự sinh khi lưu'"
            />
            <input
              v-else
              v-model="form[field.key]"
