      ...
      children: [
        ...
        },
        {
          ...
          meta: {
            ...
            breadcrumb: "Quản lý sản phẩm / Danh sách",
          },
        },
        {
          ...
          meta: {
            ...
            breadcrumb: "Quản lý sản phẩm / Biến thể",
          },
        },
        {
        ...
        },
        {
          ...
          name: "AdminQuiz",
          component: () =>
            import("@/views/admin/recommendation/QuizManager.vue"),
          meta: {
            title: "Quiz loại da",
            breadcrumb: "Gợi ý & Cá nhân hóa / Quiz loại da",
          },
        },
        {
          ...
          component: () =>
            import("@/views/admin/recommendation/RecommendRules.vue"),
          meta: {
            title: "Luật gợi ý",
            breadcrumb: "Gợi ý & Cá nhân hóa / Luật gợi ý",
          },
        },
        {
          ...
          name: "AdminRoutine",
          component: () =>
            import("@/views/admin/recommendation/RoutineManager.vue"),
          meta: {
            title: "Routine chống nắng",
            breadcrumb: "Gợi ý & Cá nhân hóa / Routine chống nắng",
          },
        },
        {
          path: "uv",
